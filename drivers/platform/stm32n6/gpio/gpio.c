...
/*
 * STM32N6 HAL splits the EXTI callback into rising/falling; route both to the
 * same per-line dispatch so a registered edge (rising, falling, or both) lands
 * in one callback. The line lookup is edge-agnostic.
 */
